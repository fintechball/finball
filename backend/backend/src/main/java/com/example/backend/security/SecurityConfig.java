...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOriginPattern("https://j9e106.p.ssafy.io:80"); // local 테스트 시
        configuration.addAllowedOriginPattern("https://j9e106.p.ssafy.io:5173"); // local 테스트 시
